...
function smarty_prefilter_form($tpl_source, &$smarty)
{
	...
	$replace=array(
		'{/capture}{insert name="formaddinputpart" \\2 input=\\1 data=$smarty.capture.formdata}{capture name="formdata"}',
		'{/capture}{insert name="formaddinputhiddenpart" \\2 input=\\1 data=$smarty.capture.formdata}{capture name="formdata"}',
		'{/capture}{insert name="formaddlabelpart" \\2 for=\\1 data=$smarty.capture.formdata}{capture name="formdata"}',
