<?php /* Smarty version 2.6.16, created on 2013-04-29 08:36:27
         compiled from /var/www/vhosts/klmchauffeurs.com/httpdocs/templates/admin2/source/modules/mod_structure_manager/sub/addFormForm.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'formadddatapart', '/var/www/vhosts/klmchauffeurs.com/httpdocs/templates/admin2/source/modules/mod_structure_manager/sub/addFormForm.tpl', 446, false),)), $this); ?>
<?php ob_start(); ?><div id="newFormContentOption" style="display: none;">
...
<ul>
<li id="form_head" class="newFormFields_controls"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/form_head.gif" width="21" height="16" align="absmiddle" alt="" /> tekst</li>
<li id="form_text" class="newFormFields_controls"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/form_i_text.gif" width="21" height="16" align="absmiddle" alt="" /> linia tekstu</li>
<li id="form_textarea" class="newFormFields_controls"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/form_i_textarea.gif" width="21" height="16" align="absmiddle" alt="" /> pole tekstowe</li>
<li id="form_select" class="newFormFields_controls"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/form_i_select.gif" width="21" height="16" align="absmiddle" alt="" /> lista wyboru</li>
<li id="form_checkbox" class="newFormFields_controls"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/form_i_checkbox.gif" width="21" height="16" align="absmiddle" alt="" /> checkbox</li>
<li id="form_radio" class="newFormFields_controls"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/form_i_radio.gif" width="21" height="16" align="absmiddle" alt="" /> radio</li>
<li id="form_pass" class="newFormFields_controls"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/form_i_pass.gif" width="21" height="16" align="absmiddle" alt="" /> hasło</li>
<li id="form_date" class="newFormFields_controls"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/form_i_text.gif" width="21" height="16" align="absmiddle" alt="" /> data</li>
</ul>
</div>
</div>
...
var fi_id = ';  echo $this->_tpl_vars['fi_id'];  echo ';
...
makeNewField = function(type, text, field, fi_id) {
	...
	switch(type){
		...
		case \'form_checkbox\':
		 ...
		 case \'form_radio\':
		 	...
		 	break;
		 case \'form_date\':
		 	r2 += \'<input type="text" id="ncFF_\'+field+\'" value="dd-mm-rrrr" /> <img src="';  echo $this->_tpl_vars['__imageRoot__'];  echo '/icons/calendar_add.png" align="absmiddle" alt="" /> \';
		 	break;
	}
	r2 += \'</span>\';
	r += r2;		 
	...
	r += '<td class="form_field_Top"><a href="#" onclick="move_li(\'contactForm_form_list\', \'thelist_'+field+'\', \'up\'); return false"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/order_arrow_up.gif"></a> <a href="#" onclick="move_li(\'contactForm_form_list\', \'thelist_'+field+'\', \'down\'); return false"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/order_arrow_down.gif"></a> <a href="#" onClick="editField(\''+field+'\'); return false"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/icons/icon_edit.gif" /></a> <a href="#" onClick="delField(\''+field+'\'); return false"><img src="<?php echo $this->_tpl_vars['__imageRoot__']; ?>
/icons/icon_del.gif" /></a></td>';
	<?php echo '
	r += \'</tr>\';
	r += \'</table>\';	 
	return r;
