 ...
 */
session_start();
include("../../../../../../../../../inc/paths_info.inc.php");
/*------------------------------------------------------------------------------*/
...
$fckphp_config['basedir'] = substr(CFGF_DOCUMENT_FS_ROOT, 0, -1);
/*==============================================================================*/
...
/*------------------------------------------------------------------------------*/
$fckphp_config['urlprefix'] = substr(CFGF_DIR_WS_HTTP_CATALOG, 0, -1);
/*==============================================================================*/
...
$fckphp_config['ResourceAreas']['media'] =array(
	'AllowedExtensions'	=>	array("jpg","gif","jpeg","png","tiff","tif","swf","fla","zip","doc","xls","pdf","rtf","csv","jpg","gif","jpeg","png","avi","mpg","mpeg","swf","fla"),
	'AllowedMIME'		=>	array(),
	'MaxSize'		=>	1000000,
	'DiskQuota'		=>	1000000,
	'HideFolders'		=>	array("^\."),
...
/*------------------------------------------------------------------------------*/
$fckphp_config['DiskQuota']['Global']=1000000; //In MBytes (default: 50mb)
/*==============================================================================*/
...
/*------------------------------------------------------------------------------*/
$fckphp_config['ResourceTypes'] = array('media');
